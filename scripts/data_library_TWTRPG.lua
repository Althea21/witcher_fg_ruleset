...
aRecordOverrides = {
	...
	["item"] = {
		...
		aRecordDisplayClasses = { "item", "reference_magicitem", "reference_armor", "reference_drugs", "reference_cybernetics", "reference_vehicle", "reference_weapon", "reference_equipment", "reference_mountsandotheranimals", "reference_waterbornevehicles" },
